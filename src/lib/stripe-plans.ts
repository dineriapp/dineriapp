...
export const STRIPE_PLANS = {
    basic: {
        name: "Basic",
        price: 0,
        description: "Your first step online",
        priceId: null,
        features: [
            "4 links",
            "4 menu cactegories",
    ...
    pro: {
        ...
        features: [
            ...
            "Support via WhatsApp & phone",
        ],
        limits: null,
    },
    enterprise: {
        name: "Enterprise",
        description: "For restaurant groups, chains and franchises",
        price: 49,
        priceId: process.env.STRIPE_ENTERPRISE_PRICE_ID,
        features: [
            "Everything in Pro",
            "White Label Solution",
            "Full-service page management",
            "Unlimited locations",
    ...
    switch (locale) {
        ...
        case "nl":
            return {
                basic: {
                    name: "Basis",
                    description: "De eerste stap online",
                    price: 0,
                    priceId: null,
                    features: [
                        "4 Links",
                ...
                pro: {
                    ...
                    priceId: process.env.STRIPE_PRO_PRICE_ID ?? null,
                    features: [
                        "Alle links, zonder limiet",
                        "Bestelpagina in jouw huisstijl",
                        "Volledig reserveringsbeheer",
                        "Bevestigings- en annuleringsmails",
                        "Geavanceerde QR-tracking",
                        "Support via WhatsApp & telefoon",
                    ],
                    limits: null,
                },
                enterprise: {
                    name: "Enterprise",
                    description: "Voor restaurantgroepen, ketens en franchises",
                    price: 49,
                    priceId: process.env.STRIPE_ENTERPRISE_PRICE_ID ?? null,
                    features: [
                        "Alles uit het Pro plan",
                        "White Label oplossing",
                        "Fullservice pagina beheer",
