...
const TipTapMenuBar = ({ editor }: { editor: Editor }) => {
    ...
    return (
        <div className="flex flex-wrap gap-2 items-center py-2">
            ...
            <div className="flex gap-2 border-r pr-2">
                <Button
                    type="button" onClick={setLink} variant="outline" size="sm">
                    <Link2 className="w-4 h-4" />
                </Button>

                <Button
                    type="button" onClick={addYoutubeVideo} variant="outline" size="sm">
                ...
                <Popover>
                    ...
                    <PopoverContent className="w-48 p-2">
                        <div className="grid grid-cols-4 gap-1">
                            {["#ef04b1", "#39a8db", '#000000', '#ef4444', '#3b82f6', '#10b981', '#f59e0b', '#ffffff'].map((color) => (
                                <Button
                                    key={color}
