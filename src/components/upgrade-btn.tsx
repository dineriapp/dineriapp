...
const UpgradeBtn = () => {
    ...
    return (
        <Button
            ...
            className="bg-gradient-to-r from-teal-600 max-md:!aspect-square !h-[38px] to-blue-600 hover:from-teal-700 hover:to-blue-700 text-white  flex items-center gap-2 shadow-sm hover:shadow transition-all"
        >
