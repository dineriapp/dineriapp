...
export function FAQSection() {
    return (
        <section className="px-4 md:px-12 lg:px-24 py-14 lg:py-20  dark:bg-gray-900">
            <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl md:text-5xl font-bold text-[#002147] dark:text-white mb-8 text-center">
                    Frequently Asked Questions
                </h2>

                <Accordion type="single" collapsible className="w-full space-y-4">
                    <AccordionItem value="item-1" className="border rounded-xl bg-[#EBE3CC] dark:bg-gray-800 shadow-sm">
                    ...
                    <AccordionItem value="item-2" className="border rounded-xl bg-[#EBE3CC] dark:bg-gray-800 shadow-sm">
                        <AccordionTrigger className="px-6 py-4 text-lg font-semibold cursor-pointer text-[#002147] dark:text-white">
                    ...
                    <AccordionItem value="item-3" className="border rounded-xl bg-[#EBE3CC] dark:bg-gray-800 shadow-sm">
                        <AccordionTrigger className="px-6 py-4 text-lg font-semibold cursor-pointer text-[#002147] dark:text-white">
