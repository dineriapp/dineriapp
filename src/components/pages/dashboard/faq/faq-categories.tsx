    ...
    >
      {filteredCategories.length > 0 ? (
        filteredCategories.map((category, categoryIndex) => {
          ...
          const faqLimit =
            STRIPE_PLANS[plan].limits?.faqsPerCategory ?? Infinity;
              ...
              <Card className="bg-white/80 backdrop-blur-sm transition-all hover:shadow-lg">
                <CardHeader className="flex md:flex-row flex-col items-center justify-between space-y-0 pb-2">
                  <div className="space-y-1">
                    <CardTitle className="flex items-center gap-2 max-md:justify-between">
        ...
        >
          ...
          <h3 className="mb-2 text-lg font-semibold">{t("noFaqsTitle")}</h3>
