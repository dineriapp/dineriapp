    ...
    return (
        <section className="relative overflow-hidden bg-[#F8F9FB] py-14 900:py-14">
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -top-[40%] -right-[10%] h-[500px] w-[500px] rounded-full bg-gradient-to-br from-[#002147]/20 to-[#2ECC71]/10 blur-3xl"></div>
            ...
            <div className="max-w-[1200px] relative w-full mx-auto px-4">
                <div className="flex items-start 900:gap-1 gap-14 900:items-center 900:flex-row flex-col justify-between w-full">
                    <div className="max-w-2xl w-full">
                        ...
                        <h1 className="mb-3 md:mb-6 text-[44px] font-bold leading-[1.05] tracking-tight text-[#002147] md:text-6xl lg:text-6xl">
                            The way to elevate{' '}
