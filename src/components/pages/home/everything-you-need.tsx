...
const EverythingYouNeed = () => {
    return (
        <div className='bg-[#D7D0BC] w-full px-5 py-[31px] flex items-center justify-center'>
            <div className='w-full max-w-[1282px] flex items-center lg:flex-row flex-col justify-between gap-8 lg:gap-[93px]'>
                        ...
                        {/* left items */}
                        {
                            [
                                ...
                                },
                                {
                                    ...
                                    description: "Link all your social profiles in one place and boost your visibility across platforms.",
                                    bgColor: "#F6E3D5"
                                },
                                ...
                                return <div
                                    ...
                                    <div className='w-full flex items-center justify-center lg:h-[92px]'>
                                        <div className='w-full max-w-[151px] flex items-center justify-end'>
                                            <h3 className='text-[#0C121D]/25 font-poppins font-[900] text-[45px] sm:text-[57px] leading-[1.1] lg:leading-auto'>
                                                {item.number}
                                            </h3>
                                        </div>
                                    </div>
                ...
                <div className='w-full '>
                    ...
                    <button className='mt-6 sm:mt-10 px-[36px] bg-[#000000] rounded-full hover:opacity-70 cursor-pointer transition-all h-[61px] curpo text-[#FFFFFF] font-[600] font-poppins text-lg'>
                        Join Now
                    </button>
                </div>
            </div>
