...
export function MobilePreview() {
        ...
        return (
            <div className="flex flex-wrap items-center justify-center gap-3">
                {[Instagram, Facebook, MessageCircle, Mail, MapPin].map((Icon, idx) => (
                    <div key={idx} className="hover:scale-[1.1] cursor-pointer text-main-action">
    ...
    return (
        <div className="relative w-[300px]">
            {/* Glow effects */}
            <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-r from-main-action/20 to-[#f4b400]/20 transform rotate-3 blur-sm"></div>
            <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-r from-main-action/10 to-[#f4b400]/10 transform -rotate-2 blur-sm"></div>
            ...
            <div className="relative rounded-[2.5rem] bg-[#0f172a] p-2 shadow-2xl">
                ...
                <div className="overflow-hidden rounded-[2rem] bg-[#1e293b] min-h-[550px]">
                    ...
                    <div className="px-6 py-4 text-white/80">
                        <div className="mx-auto mb-4 h-20 w-20 overflow-hidden rounded-full border-4 border-main-action bg-gray-300">
                    ...
                    <div className="space-y-2 px-4 py-2">
                        {[
                            ...
                            return (
                                ...
                                >
                                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-main-action to-main-action">
                    ...
                    <p className="text-xs mx-auto text-center mt-4 text-white">
                        Powered by{" "}
                        <Link href="/" className="underline text-main-action" >
                            dineri.app
                        </Link>
                    </p>
                </div>
