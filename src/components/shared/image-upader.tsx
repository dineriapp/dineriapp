...
import { getSignedURL } from "@/lib/server/functions/upload-to-aws";
    ...
    return (
        <div
            ...
            className={cn(
                ...
                over?.id === file.id && !isDragging && "ring-2 ring-orange-400 bg-orange-50/10"
            )}
        >
            {!isDragDisabled && (
                <button
            ...
            <div className={cn("aspect-square bg-gray-50 flex items-center justify-center", PreviewItemClassName)}>
                {renderPreview()}
            </div>
            ...
            {file.status === "uploading" && (
                <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center">
                    ...
                    <Progress value={file.progress} className="w-3/4 h-1 bg-gray-200 [&>div]:bg-orange-500" />
...
export function MultiImageUploader({
    ...
    const finalAcceptTypes = acceptTypes ? [...acceptTypes] : [...defaultAcceptedTypes];
    if (acceptVideos) {
            ...
            {!limitReached && !uploading && (
                <div
                    ...
                    className={cn(
                        ...
                        dragging ? "border-orange-500 bg-orange-50/10" : "border-gray-300 bg-gray-50 hover:bg-gray-100",
                        triggerClassName
                    )}
                >
                    <input
                    ...
                    {children ? children : (
                        <>
                            ...
                            <p className="text-xs text-gray-400">{finalAcceptTypes.join(", ")} up to {maxSizeMB}MB</p>
                        </>
                    )}
                </div>
            )}
