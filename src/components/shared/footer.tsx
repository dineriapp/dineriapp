            ...
            <div className="container relative mx-auto max-w-[1200px] px-4 ">
                ...
                <div className="flex items-start justify-between 900:flex-row flex-col gap-10 pt-12 md:pt-16 pb-6 md:pb-6">
                    ...
                    <div className="flex items-start sm:flex-row flex-col justify-between 900:w-auto w-full 900:justify-center gap-6 sm:gap-30">
                        <div>
                            <h3 className="mb-6 text-sm font-semibold uppercase tracking-wider text-main-action">Product</h3>
                            <ul className="space-y-2">
                                {["Features", "Pricing", "Testimonials", "FAQ", "Demo", "Support"].map((item) => (
                                    <li key={item}>
                                        <Link href={`#${item.toLowerCase()}`} className="text-white/90 hover:text-main-action">
                                            {item}
                                        </Link>
                                    </li>
                                ))}
                        ...
                        <div>
                            <h3 className="mb-6 text-sm font-semibold uppercase tracking-wider text-main-action">Company</h3>
                            <ul className="space-y-2">
                        ...
                        <div>
                            <h3 className="mb-6 text-sm font-semibold uppercase tracking-wider text-main-action">Legal</h3>
                ...
                <div className="my-8 rounded-2xl border border-[#334155] bg-[#1e293b]/80 p-8 backdrop-blur-sm">
                    <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
                        <div>
                            ...
                            <p className="mt-2 text-white/80">Create your restaurant profile in minutes</p>
                        </div>
                        <Link href="/signup">
                            <Button
                                size="lg"
                ...
                <div className="flex flex-col items-center justify-between border-t border-[#334155]/50 py-8 md:flex-row">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 text-sm text-white">
                        <Link href="/terms" className="hover:text-main-action">Terms of Service</Link>
                        <span className="text-white/80">•</span>
                        <Link href="/privacy" className="hover:text-main-action">Privacy Policy</Link>
                        <span className="text-white/80">•</span>
                        <Link href="/cookies" className="hover:text-main-action">Cookie Policy</Link>
                    </div>
                </div>
            </div>
        </footer>
