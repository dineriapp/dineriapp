...
export function WelcomePopup({
  ...
  useEffect(() => {
    if (eventsShow) {
      if (upcomingEvents.length <= 1 || !restaurant.event_announcements_enabled)
        return;
    ...
    restaurant.event_rotation_speed,
    restaurant.event_announcements_enabled,
  ]);
  ...
  const hasEvents =
    ...
    restaurant.event_announcements_enabled !== false;
  ...
  const showButton =
    restaurant.welcome_popup_show_button !== false && !hasEvents;
                ...
                {eventsShow && hasEvents && currentEvent ? (
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <span>
                        {formatEventDate(currentEvent.date.toISOString())}
                      </span>
                    </div>
              ...
              {actionsShow && (
                ...
                >
                  ...
                  {hasEvents && currentEvent?.ticket_url && (
                    ...
                    >
                      <span>{t("event_ticket_button")}</span>
