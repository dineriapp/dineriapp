...
//             <div className="mt-4">
//                 <div className={EDITOR_PROSE} dangerouslySetInnerHTML={{ __html: html }} />
//             </div>
//         </div>
//     );
// }
...
//     children,
// }: Props) {
//     // If you want to display defaults even when null:
...
//                     <DialogTitle className="text-xl flex items-center gap-2"> <Notebook className="text-green-500" /> Restaurant Policies</DialogTitle>
//                     <DialogDescription>
//                         These policies are shown to customers during the reservation flow.
//                     </DialogDescription>
//                 </DialogHeader>
...
//                                     This restaurant has not created reservation policies yet.
//                                 </p>
//                             </div>
//                         </div>
//                     ) : (
