        ...
        <Card className="p-6 gap-0">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <div className="bg-blue-50 rounded-lg p-3 text-center">
              ...
              <p className="text-xs text-gray-600">{t("infoCards.date")}</p>
            ...
            <div className="bg-blue-50 rounded-lg p-3 text-center">
              ...
              <p className="text-xs text-gray-600">{t("infoCards.time")}</p>
              <p className="text-sm font-medium text-gray-900">
            ...
            <div className="bg-blue-50 rounded-lg p-3 text-center">
              ...
              <p className="text-xs text-gray-600">{t("infoCards.guests")}</p>
              <p className="text-sm font-medium text-gray-900">
            ...
            <div className="bg-blue-50 rounded-lg p-3 text-center">
              ...
              <p className="text-xs text-gray-600">{t("infoCards.status")}</p>
          ...
          <div className="text-center p-3 bg-gray-100 rounded-lg mb-6">
            <p className="text-xs text-gray-600">{t("referenceInfo.label")}</p>
