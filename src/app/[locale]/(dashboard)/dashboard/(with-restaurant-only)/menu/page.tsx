...
import MenuCategoryComponent, {
  MenuCategoryWithItems,
} from "@/components/pages/dashboard/menu/menu-category";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
    ...
    <>
      <main className="max-w-[1200px] mx-auto px-4 py-8">
        <motion.div
          ...
          className="mb-8 flex flex-col gap-4  flex-wrap md:flex-row md:items-center md:justify-between"
        >
          <div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <div className="relative bg-white rounded-full ">
              ...
              <Input
                ...
                className="pl-12 font-poppins rounded-full sm:w-64 w-full h-[42px]"
              />
            </div>
              ...
              <>
                <Button
                  ...
                  onClick={() => {
                    ...
                    const limit =
                      getStripePlans(locale)[plan].limits?.menuCategories;
                    openPopup(
                      t("categoryLimitMessage", {
                        limit: limit || "",
                        planName: planName,
                      }),
                    );
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setNewCategoryshow_in_quick_menu(
                          category.show_in_quick_menu,
                        );
                      }}
                    ...
                    <Button
                      ...
                      disabled={
                        categoryIndex === 0 || reorderCategoryMutation.isPending
                      }
                    ...
                    {category.items && category.items.length > 0 && (
                      <Button
                        ...
                        onClick={() => {
                          ...
                          const limit =
                            getStripePlans(locale)[plan].limits
                              ?.menuItemsPerCategory;

                          if (
                            limit !== undefined &&
                            category.items.length >= limit
                          ) {
                            const planName = getStripePlans(locale)[plan].name;
                            openPopup(
                              t("itemLimitMessage", {
