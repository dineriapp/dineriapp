...
export default function BusinessInformationPage() {
  ...
  async function handleLogoFileChange(file?: File) {
    ...
    if (!file.type.startsWith("image/")) {
      setErrors((p) => ({
        ...p,
        logo_url: t("form.errors.logo_upload_not_file"),
      }));
      return;
    }
    ...
    try {
      ...
      setErrors((p) => ({
        ...p,
        logo_url: t("form.errors.logo_upload_failed"),
      }));
    } finally {
      ...
      <Card className="border-gray-200 pt-0 box-shad-every-2 shadow-md">
        ...
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <div className="flex">
                ...
                <Input
                  ...
                  className={`rounded-l-none focus:border-emerald-500 focus:ring-emerald-500 ${
                    errors.slug
                      ? "border-red-500 focus:border-red-500 focus:ring-red-500"
                      : ""
                  }`}
            ...
            <p className="text-xs text-gray-500">{t("form.help.slug")}</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs text-gray-500">
              <span>{t("form.help.bio_optional")}</span>
          ...
          {/* Logo URL */}
          <div className="space-y-2">
            <Label htmlFor="logo_url">{t("form.labels.logo")}</Label>
            <div className="relative">
              {/* Hidden file input */}
              <Input
                id="logo_file"
                  ...
                  <div className="size-40! rounded-full overflow-hidden">
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        setErrors((prev) => ({
                          ...prev,
                          logo_url: "Unable to load image from this URL",
                        }));
                      }}
                      onLoad={() => {
                        if (
