...
export default function AreasPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Stats */}
      <div className="grid 900:grid-cols-3 md:grid-cols-2 gap-4">
        <StatCard
      ...
      <div className="flex justify-between items-center gap-4 max-md:flex-col">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogTrigger asChild>
            <Button className="bg-black text-white max-md:w-full h-11 hover:bg-gray-800 flex items-center gap-2">
          ...
          <DialogContent className="bg-white">
            <DialogHeader>
              <DialogTitle>{t("actions.addNewAreaTitle")}</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
              <div className="space-y-2">
                <Label>{t("actions.areaNameLabel")}</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label>{t("actions.statusLabel")}</Label>
                <Select
                  value={newArea.active}
                  onValueChange={(val) =>
                    setNewArea({ ...newArea, active: val })
                  }
                >
                  ...
                  <SelectContent>
                    <SelectItem value="true">{t("actions.active")}</SelectItem>
          ...
          >
            ...
            <div
              className={`absolute top-0 left-0 w-full h-1 ${
                area.active ? "bg-green-500" : "bg-red-400"
              }`}
            />
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="bg-white">
          <DialogHeader>
            <DialogTitle>{t("actions.editAreaTitle")}</DialogTitle>
          </DialogHeader>
          {editArea && (
            <div className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setEditArea({ ...editArea, active: val === "true" })
                  }
                >
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder={t("actions.statusPlaceholder")} />
