...
export default function PaymentsPage() {
  ...
  const handleExportCSV = () => {
    ...
    const headers = [
      t("csv.headers.id"),
      t("csv.headers.reservationId"),
      t("csv.headers.amount"),
      t("csv.headers.currency"),
      t("csv.headers.status"),
      t("csv.headers.paymentMethod"),
      t("csv.headers.paidAt"),
      t("csv.headers.transactionId"),
    ];
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full sm:w-auto">
          <Input
            ...
            className="!bg-white w-full sm:w-[300px] h-11!"
            aria-label={t("filters.searchAriaLabel")}
          />

          <div className="flex items-center gap-3">
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              <SelectTrigger className="w-[180px] !bg-white h-11!">
            ...
            <Button
              variant="outline"
              className="flex !bg-white items-center gap-2 h-11!"
        ...
        <Button
          className="bg-black !text-white hover:bg-gray-800 flex items-center gap-2 w-full h-11! sm:w-auto"
                ...
                <TableRow key={payment.id} className="hover:bg-gray-50">
                  ...
                  <TableCell className="capitalize">
                    {payment.payment_method
                      ? paymentMethodeTranslation(payment.payment_method)
                      : "N/A"}
                  </TableCell>
                  <TableCell>
                    {payment.paid_at
