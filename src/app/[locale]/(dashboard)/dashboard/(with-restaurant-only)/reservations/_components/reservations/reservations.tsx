...
import { useReservations, useReservationStats } from "@/lib/reservation-queries"
            ...
            <div className="space-y-3">
                {filteredReservations.length === 0 ? (
                    ...
                    filteredReservations.map((reservation) => (
                        <ReservationCard key={reservation.id} reservation={reservation} restaurant={restaurant as Restaurant} />
                    ))
                )}
            </div>
        </div>
