...
const NewReservationFormDialog = ({ restaurant }: { restaurant: RestaurantWithCount }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result.success) {
                alert(`Reservation created successfully!${result.deposit?.amount > 0 ? ` Deposit: ${result.deposit.amount} ${settings?.deposit_settings?.depositCurrency || 'EUR'}` : ''}`);
...
export default NewReservationFormDialog;